"""
This script needs to be launch in parallel of a routine : they will communicate via UDP, like with the real robot. Thus this should be used with a routine using RealQArmController.
"""
